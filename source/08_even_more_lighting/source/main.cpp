...
static void Update(float secondsElapsed) {
    ...
    //kk glfwGetCursorPos(gWindow, &mouseX, &mouseY);
    //kk gCamera.offsetOrientation(mouseSensitivity * (float)mouseY, mouseSensitivity * (float)mouseX);
    //kk glfwSetCursorPos(gWindow, 0, 0); //reset the mouse, so it doesn't go out of the window
